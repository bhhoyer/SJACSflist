...
OUTPUT_FILE="/home/$USER/tmp/test_file.csv"
...
while read freqlist ; do
    ...
    echo "$ch_no,$freq,$dup,$offset,$TStep,$Mode,$Skip,$Tone,$rTone,$cTone,$DtcsCode,$DtcsPolarity,$DvSql,$DvSqlCode,$URCALL,$RPT1CALL,$RPT2CALL" >> $OUTPUT_FILE
done < $INPUT_FILE
